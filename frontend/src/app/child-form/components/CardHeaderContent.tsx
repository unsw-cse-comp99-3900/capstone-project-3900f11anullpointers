...
export function CardHeaderContent({
  ...
  return (
    <>
      <CardHeader>
        <CardTitle className={`${textLarge ? 'text-5xl' : 'text-3xl'} ${dyslexicFont ? lexend.className : ""} text-center pb-3`}>Patient's Consent & Information Sheet (Children)</CardTitle>
        <CardDescription className={`${textLarge ? 'text-xl' : 'text-sm'} ${highContrast ? "filter contrast-200" : ""} ${dyslexicFont ? lexend.className : ""}`}>
